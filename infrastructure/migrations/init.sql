-- Creation de la base de donnees artbox
-- Cette base sera automatiquement creee par Docker via les variables d'environnement
...
SELECT COUNT(*) as 'Nombre d''oeuvres inserees' FROM oeuvres;
